...
#[derive(Accounts)]
pub struct RemoveMinterAuthority<'info> {
    #[account(
      mut,
      seeds = [
        PREFIX,
...
pub fn remove(ctx: Context<RemoveMinterAuthority>, args: RemoveMinterAuthorityArgs) -> Result<()> {
...
pub struct RemoveMinterAuthorityArgs {
